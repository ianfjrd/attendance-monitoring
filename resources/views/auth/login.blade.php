                ...
                <div>
                        <div class="top-1/2 right-0 mx-1 md:mr-72 w-full h-contain flex justify-center bg-cover max-w-xl p-4 sm:p-6 md:py-32" style="background-image: url('./images/cardlogin.png');">
                            <form class="h-[420px] w-[350px] space-y-6" method="POST" action="{{ route('login') }}">
                                ...
                                <h5 class="text-xl font-medium text-white text-center">Fill up form below</h5>
                                <x-validation-errors/>
                                <div>
                                    <label for="email" class="block mb-2 text-sm font-medium text-white" value="{{ __('Email') }}">E-mail</label>
                                ...
                                <div>
                                    <label for="password" class="block mb-2 text-sm font-medium text-white" value="{{ __('Password') }}">Password</label>
