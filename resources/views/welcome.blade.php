...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="absolute w-[134px] h-[44px] left-[380px] top-[721px] bg-[#8EC33F] shadow-md rounded-3xl text-center"><a class="h-[44px] text-white text-lg font-bold leading-[44px]">TIME IN</a></div>
    <div class="absolute w-[134px] h-[44px] left-[557px] top-[721px] bg-transparent border border-solid border-[#8EC33F] shadow-md rounded-3xl text-center"><a class="leading-[44px] text-[#8EC33F] font-bold">TIME OUT</a></div>
    </body>
