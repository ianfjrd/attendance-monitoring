...
@section('content')
    <main class="flex flex-cols-2">
        ...
        <div class=" grid grid-rows-3 justify-end pr-16 w-1/2">
            <div class="flex flex-1 justify-center text-center md:max-w-[352px] pb-5 ">
                <div class="panel relative transition-colors duration-300 dark text-white bg-gray-800 hover:bg-gray-700 flex h-full w-full flex-shrink-0 flex-col justify-between rounded-2xl px-3 py-1 bg-blue/7 hover:bg-blue/13"
        ...
        <div class=" justify-center px-10 py-16">

            <div class="wrapper w-[450px] bg-white rounded-[10px] shadow-md">
                <header>
