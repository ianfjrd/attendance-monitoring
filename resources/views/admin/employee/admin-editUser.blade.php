        ...
        <div class="grid grid-cols-2 py-5">
            <div class="flex flex-col justify-center items-center text-center">
                ...
                <input id="password" disabled value="12345678"
                    class=" cursor-not-allowed text-center block py-2.5 px-0 w-1/2 text-1xl bg-transparent border-0 border-b-2 appearance-none text-white border-[#8EC33F] focus:outline-none focus:ring-0 focus:border-[#8EC33F] peer"
