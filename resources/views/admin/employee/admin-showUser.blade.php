...
@section('content')
    ...
    <form id="updateUserForm" method="POST" action="{{ route('user.update', $user->id) }}">
        ...
        <div class="flex justify-center items-center">
            <label for="title" class="text-4xl font-bold text-white pt-5 pb-10">Edit Employee Form</label>
        </div>
        ...
        <div class="grid grid-cols-2 py-5">
            <div class="flex flex-col justify-center items-center text-center">
                ...
                <input type="number" name="age" value="{{ old('age', $user->age) }}" disabled
                    class=" text-center block py-2.5 px-0 w-1/4 text-2xl bg-transparent border-0 border-b-2 border-gray-300 appearance-none text-white border-[transparent] focus:outline-none focus:ring-0 focus:border-[transparent] peer"
        ...
        <div class="grid grid-cols-3 pt-5 ">
            <div class="flex flex-col text-center items-center justify-center">
                ...
                <input disabled type="time" name="time_in_user"
                    ...
                    class="border-0 border-b-2 text-white bg-transparent text-2xl w-1/2 px-0 block py-2.5 appearance-none border-gray-300 border-[transparent] focus:outline-none focus:ring-0 focus:border-[transparent] peer" />
                @error('time_in_user')
                    <small class=" italic text-red-400 ">{{ $message }}</small>
                @enderror
            </div>
