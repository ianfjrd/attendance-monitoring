    ...
    <form id="updateUserForm" method="POST" action="{{ route('user.update', $user->id) }}">
        ...
        <div class="grid grid-cols-2 py-5">
            <div class="flex flex-col justify-center items-center text-center">
                ...
                <input type="number" name="age" value="{{ old('age', $user->age) }}" disabled
                    class=" text-center block py-2.5 px-0 w-1/4 text-2xl text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-[transparent] dark:focus:border-[transparent] focus:outline-none focus:ring-0 focus:border-[transparent] peer"
            ...
            <div class="flex flex-col justify-center items-center text-center">
                ...
                <input id="name" disabled
                    class=" text-center block py-2.5 px-0 w-1/2 text-2xl text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-[transparent] dark:focus:border-[transparent] focus:outline-none focus:ring-0 focus:border-[transparent] peer"
                    type="text" name="name" value="{{ old('name', $user->department) }}" required autofocus
                    autocomplete="name" placeholder="John Doe" />
                @error('name')
                    <small class=" italic text-red-400 ">{{ $message }}</small>
                @enderror
        ...
        <div class="grid grid-cols-2 py-5">
            ...
            <div class="flex flex-col justify-center items-center text-center">
                ...
                <input id="name" disabled
                    class=" text-center block py-2.5 px-0 w-1/2 text-2xl text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-[transparent] dark:focus:border-[transparent] focus:outline-none focus:ring-0 focus:border-[transparent] peer"
                    type="text" name="name" value="{{ old('name', $user->role) }}" required autofocus
                    autocomplete="name" placeholder="John Doe" />
                @error('name')
                    <small class=" italic text-red-400 ">{{ $message }}</small>
                @enderror
            ...
            <div class="flex flex-col justify-center items-center text-center">
                ...
                <input id="phoneNumber" value="{{ old('phone_number', $user->phone_number) }}" disabled
                    class=" text-center block py-2.5 px-0 w-1/2 text-2xl text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-[transparent] dark:focus:border-[transparent] focus:outline-none focus:ring-0 focus:border-[transparent] peer"
        ...
        <div class="justify-center items-center text-center my-12">
            <div class="flex flex-col justify-center items-center text-center">
                ...
                <input id="address" value="{{ old('address', $user->valid_id_number) }}" disabled
                    class=" text-center block py-2.5 px-0 w-1/2 text-2xl text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-[transparent] dark:focus:border-[transparent] focus:outline-none focus:ring-0 focus:border-[transparent] peer"
        ...
        <div class=" mx-12">
            <ul
                ...
                <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                    <div class="flex items-center pl-3">
                        <input disabled {{ is_array(old('workdays')) || in_array('Monday', $workdays) ? 'checked' : '' }}
                ...
                <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                    <div class="flex items-center pl-3">
                        <input disabled {{ is_array(old('workdays')) || in_array('Tuesday', $workdays) ? 'checked' : '' }}
                ...
                <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                    <div class="flex items-center pl-3">
                        <input disabled
                            {{ is_array(old('workdays')) || in_array('Wednesday', $workdays) ? 'checked' : '' }}
                ...
                <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                    <div class="flex items-center pl-3">
                        <input disabled {{ is_array(old('workdays')) || in_array('Thursday', $workdays) ? 'checked' : '' }}
                ...
                <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                    <div class="flex items-center pl-3">
                        <input disabled {{ is_array(old('workdays')) || in_array('Friday', $workdays) ? 'checked' : '' }}
                ...
                <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                    <div class="flex items-center pl-3">
                        <input disabled {{ is_array(old('workdays')) || in_array('Saturday', $workdays) ? 'checked' : '' }}
        ...
        <div class="grid grid-cols-3 pt-5 ">
            <div class="flex flex-col text-center items-center justify-center">
                ...
                <input disabled type="time" name="time_in_user"
                    value="{{ old('time_in_user', $user->time_in_user) }}"
                    class="border-0 border-b-2 dark:text-white bg-transparent text-2xl w-1/2 px-0 block py-2.5 text-gray-900 appearance-none border-gray-300 dark:border-[transparent] dark:focus:border-[transparent] focus:outline-none focus:ring-0 focus:border-[transparent] peer" />
                @error('time_in_user')
                    <small class=" italic text-red-400 ">{{ $message }}</small>
                @enderror
            </div>
            ...
            <div class="flex flex-col text-center items-center justify-center">
                ...
                <input disabled type="number" name="break_duration"
                    value="{{ old('break_duration', $user->break_duration) }}"
                    class=" text-center block py-2.5 px-0 w-1/4 text-2xl text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-[transparent] dark:focus:border-[transparent] focus:outline-none focus:ring-0 focus:border-[transparent] peer"
            ...
            <div class="flex flex-col text-center items-center justify-center">
                ...
                <input disabled type="time" name="time_out_user"
                    value="{{ old('time_out_user', $user->time_out_user) }}"
                    class="border-0 border-b-2 dark:text-white bg-transparent text-2xl w-1/2 px-0 block py-2.5 text-gray-900 appearance-none border-gray-300 dark:border-[transparent] dark:focus:border-[transparent] focus:outline-none focus:ring-0 focus:border-[transparent] peer" />
                @error('time_out_user')
                    <small class=" italic text-red-400 ">{{ $message }}</small>
                @enderror
        ...
        <div class="flex justify-center items-center py-10">
            <a id="formSubmit" href="{{ route('user.edit', ['user' => $user->id]) }}"
