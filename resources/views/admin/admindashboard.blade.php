        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
           ...
           <ul class="space-y-2 font-medium">
            ...
            {{-- <li>
             ...
             <li>
                ...
                <ul id="dropdown-example" class="flex flex-col ml-5 border-l-2 border-l-gray-700">
                    <li>
                     ...
                     <li>
                        <a href="{{route('user.create')}}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg ml-1 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
             ...
             <li>
               <a href="{{route('role.index')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
