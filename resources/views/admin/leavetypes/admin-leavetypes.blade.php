...
@section('content')
    @include('typesOfLeavesListBase64')
                ...
                <tbody>
                    @foreach ($leavetypes as $leavetype)
                        <tr>
                            ...
                            <td>
                                <button data-modal-target="{{ $leavetype->name }}"
                                    data-modal-toggle="{{ $leavetype->name }}" class="underline">Show</button>
                                <a href="{{ route('leavetypes.edit', $leavetype->id) }}" class="underline">Update</a>
                        ...
                        <div class="p-4 sm:ml-64 my-auto absolute  ">
                            <div class="p-4 text-white ">
                                <!-- Show modal -->
                                <div id="{{ $leavetype->name }}" tabindex="-1" aria-hidden="true"
                                    ...
                                    <div class="relative w-full max-w-md max-h-full  ">
                                        ...
                                        <div class="relative rounded-lg shadow bg-gray-700">
                                            <button type="button"
                                                ...
                                                data-modal-hide="{{ $leavetype->name }}">
                        ...
                        <script type="text/javascript">
                            ...
                            const $targetEl = document.getElementById('{{ $leavetype->name }}');
        ...
        $(document).ready(function() {
            $('#example').DataTable({
                ...
                buttons: [{
                        text: '➕Type of leave',
                        action: function() {
                            window.location.href = "{{ route('leavetypes.create') }}";
                        }
                    },
                    'copyHtml5',
                    {
